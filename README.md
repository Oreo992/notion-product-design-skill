...
`references/source-index.md` lists the underlying sources. The repository also includes the local research transcript used for exact 2022 talk wording and timestamps.
